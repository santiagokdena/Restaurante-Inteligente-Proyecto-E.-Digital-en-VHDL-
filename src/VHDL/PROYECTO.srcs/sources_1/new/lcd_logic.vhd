...
ARCHITECTURE behavior OF lcd_logic IS
...
div: divisor 
  PORT MAP(clk=>clk,rst=>'0',q=>clkdiv,T=>x"7735940"); --reset activo en alto 7735940
  ...
  if (clk'event and clk='1') then
        case state is 
            ...
            when options=>--opciones
                ...
                if tecla="00110001" or tecla="00110010" or tecla="00110011" then --si se escoge una opcion, se limpia pantalla
                    lcd_enable<='0';
                ...
                elsif tecla="00110101" then --salir
                    lcd_enable<='0';
                    state<=Welcome_moving;
                    numchar:=-2;
                end if;
            when s3=>
                    ...
                    if (lcd_busy='0' and lcd_enable='0') then     
                            ...
                            if numchar=-2 then --limpia pantalla
                                ...
                                if en_teclado='1' then
                                    if tecla="01000101" then --enter(E)
                                        state<=options;
                                        numchar:=-2;
                                        --v. boolena
                                    else --digita numeros
