...
entity LCD is --cambiarle el nombre
  PORT(
      clk: in std_logic;
...
u_logic: lcd_logic
    port map(clk=>clk,lcd_busy=>sig_busy,lcd_enable=>sig_en,lcd_bus=>sig_bus,lcd_reset=>sig_reset,en_teclado=>sig_en_teclado,tecla=>sig_tecla);   
